...
\begin{itemize}
    \item \textbf{Viabilidad de la detección de interacciones.} Se ha demostrado que es posible automatizar la detección de interacciones farmacológicas y dotar al sistema de un componente de interpretabilidad clínica analizando las isoenzimas del sistema CYP450, superando el modelo clásico de las plataformas ya existentes a la hora de mostrar la información de manera más sencilla.
...
\subsection*{Justificación del uso de CIMA como base de datos de referencia}
