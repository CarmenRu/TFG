...
\begin{itemize}
    \item \textbf{Viabilidad de la detección de interacciones.} Se ha demostrado que es posible automatizar la detección de interacciones farmacológicas y construir un sistema interpretable basado en las isoenzimas CYP450 que integra en una única plataforma la evaluación del riesgo, el mecanismo farmacocinético y funcionalidades adicionales de apoyo a la decisión.
    ...
    \item \textbf{Utilidad del cuadro de mando integrado:} La interfaz web interactiva centraliza de manera eficiente cuatro flujos de información críticos para el personal facultativo (el nivel de riesgo, el porqué biológico de la interacción y el perfil de toxicidad de SIDER junto con propuestas automáticas de alternativas terapéuticas). El diseño de esta herramienta permite al usuario visualizar de manera eficaz la información necesaria para modificar algún principio activo de los recetados en caso de ser necesario.
...
Durante el desarrollo del presente software, se han tomado decisiones metodológicas clave que transformaron el enfoque del proyecto:
