...
En este apartado se describen los requisitos mínimos necesarios para ejecutar InteraDD, tanto de forma local como mediante el despliegue realizado en la plataforma Render.
