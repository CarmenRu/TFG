...
Además, GitHub ha servido como repositorio central del proyecto, cuyo código fuente puede consultarse en:
\begin{center}
...
automatización y su capacidad de integración continua con repositorios de control de versiones como lo es GitHub.
Esto permitió agilizar el proceso de despliegue, garantizando la disponibilidad inmediata y estable de la aplicación web de cara a la fase de evaluación y defensa ante el tribunal examinador.
La aplicación desarrollada puede consultarse en:
\begin{center}
...
en el tiempo máximo de ejecución (\textit{timeout}).
