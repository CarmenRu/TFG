...
Se puede observar la planificación temporal del proyecto de una manera mas clara en el siguiente diagrama de gantt creado \ref{fig:gantt} .

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{img/Diagrama de Gantt.png} 
    \caption{Diagrama de Gantt que presenta la planificación temporal del presente proyecto.}
    \label{fig:gantt}
\end{figure}

\subsection{Planificación económica}
Al ser un proyecto desarrollado con fines académicos no ha supuesto costes directos de infraestructura.
...
Teniendo en cuenta que un ingeniero junior puede cobrar aproximadamente entre 15 y 20 euros la hora y, además, que el proyecto se ha desarrollado en 4 meses (16 semanas) una aproximación de costes humanos podría ser la recogida en la tabla \ref{tab:humanos}.
