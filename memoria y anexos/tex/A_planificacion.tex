...
PRIMERO EL CONTEXTO
LUEGO MOTIVACION
LUEGO EL PROBLEMA Y DECIR QUE ES VISUALIZACION FACIL
Por tanto el presente proyecto tiene el propósito de realizar una herramienta capaz de mostrar el nivel de interacción que puedan tener dos principios activos por separado, explicando las enzimas que se han tenido en cuenta para llegar a esa conclusión y porque, la prevalencia que tendría uno sobre otro dependiendo de las acciones que lleven a cabo en caso de que se detecte interacción, mostrar los efectos adversos asociados a cada principio y por último proponer alternativas terapéuticas consideradas seguras por el algoritmo generado. 
Q se pretende conseguir con el tfg tambien estaba
